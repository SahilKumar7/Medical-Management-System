...
public class patient {
	...
	public void viewPatientMenu() throws SQLException, IOException {
		while(true) {
			...
			break;
			case 7: System.out.println("Patient logged out!");
//			con.close();
			return;
	...
	private void bookAppointment()
	{
		...
		try {
			...
			System.out.print("Enter the date s .no: ");
...
//			System.out.print(selectedDate);
			...
			if(bill_.next())
			{
				...
				psmt.setString(5, timeSlots.get(timeslotprefer));
				psmt.setInt(6,bill);
...
//				java.util.Date d = sd.parse(reformattedStr);
//				slotsUpdate.setDate(2, new java.sql.Date(d.getTime()));
